...
{
    public class StoredProcedure : IScriptableDatabaseObject
    {
        ...
        public StoredProcedure(Database database,string owner, string name)
        {
            Database = database;
            Owner = owner;
            Name = name;
        ...
        private void BuildDefintion()
        {
            ...
            _script.AppendFormat("DROP PROCEDURE {0}", this.QualifiedName).AppendLine();
